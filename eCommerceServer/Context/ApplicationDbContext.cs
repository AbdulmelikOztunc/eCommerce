...
public sealed class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=.\\SQLEXPRESS;Initial Catalog=eCommerceDb;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    }
